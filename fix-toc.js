...
if (js.includes(targetStr)) {
  ...
  console.log('Successfully updated js/SharedUI.js');
} else {
  console.log('Target string not found in js/SharedUI.js');
}
