...
if (process.env.GROQ_API_KEY_PLANNER_4) process.env.GROQ_API_KEY_PLANNER_4 = process.env.GROQ_API_KEY_PLANNER_4.trim();
if (process.env.GROQ_API_KEY_PLANNER_5) process.env.GROQ_API_KEY_PLANNER_5 = process.env.GROQ_API_KEY_PLANNER_5.trim();
if (process.env.GROQ_API_KEY_PLANNER_6) process.env.GROQ_API_KEY_PLANNER_6 = process.env.GROQ_API_KEY_PLANNER_6.trim();
