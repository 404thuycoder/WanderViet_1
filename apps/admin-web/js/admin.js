(function () {
    ...
    document.querySelectorAll('[data-hub-tab]').forEach(btn => {
      btn.addEventListener('click', () => {
        ...
        if (targetSub) {
          ...
          setTimeout(() => {
            if (typeof activityChart !== 'undefined' && activityChart && typeof activityChart.resize === 'function') activityChart.resize();
            if (typeof distributionChart !== 'undefined' && distributionChart && typeof distributionChart.resize === 'function') distributionChart.resize();
            if (typeof sentimentChartInstance !== 'undefined' && sentimentChartInstance && typeof sentimentChartInstance.resize === 'function') sentimentChartInstance.resize();
            if (typeof deviceChartInstance !== 'undefined' && deviceChartInstance && typeof deviceChartInstance.resize === 'function') deviceChartInstance.resize();
            if (typeof userManagerChart !== 'undefined' && userManagerChart && typeof userManagerChart.resize === 'function') userManagerChart.resize();
            if (typeof placeManagerChart !== 'undefined' && placeManagerChart && typeof placeManagerChart.resize === 'function') placeManagerChart.resize();
            if (typeof logManagerChart !== 'undefined' && logManagerChart && typeof logManagerChart.resize === 'function') logManagerChart.resize();
            if (typeof aiTrendChartInstance !== 'undefined' && aiTrendChartInstance && typeof aiTrendChartInstance.resize === 'function') aiTrendChartInstance.resize();
            if (typeof revenueTrendChartInstance !== 'undefined' && revenueTrendChartInstance && typeof revenueTrendChartInstance.resize === 'function') revenueTrendChartInstance.resize();
            if (typeof revenueClassChartInstance !== 'undefined' && revenueClassChartInstance && typeof revenueClassChartInstance.resize === 'function') revenueClassChartInstance.resize();
            if (typeof commentSentimentChartInstance !== 'undefined' && commentSentimentChartInstance && typeof commentSentimentChartInstance.resize === 'function') commentSentimentChartInstance.resize();
          }, 50);
  ...
  // Default config
    ...
    function playBeep(freq = 600, duration = 0.05, vol = 0.05) {
      if (!config.sounds || config.performance) return;
      if (!audioCtx) {
