...
(function (global) {
  ...
  function wanderChatReply(_x, _x2) {
    return _wanderChatReply.apply(this, arguments);
  } // Cung cấp interface cho voice-helper.js
  function _wanderChatReply() {
    _wanderChatReply = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(userText, ctx) {
      var raw, deviceId, response, data, _t;
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            ...
            case 1:
              ...
              if (window.displayAIMessage) window.displayAIMessage(answer);
              if (window.WanderUI && window.WanderUI.trackQuestActivity) window.WanderUI.trackQuestActivity('dailyChat');
            case 2:
              return _context.a(2);
          }
        }, _callee);
